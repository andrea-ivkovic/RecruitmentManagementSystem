...
import ApplicantsByJobTitle from "../utils/ApplicantsByJobTitle";
...
export default function Dashboard() {
    ...
    useEffect(() => {
        axios.get(`${urlJobs}/getLatestCompanyJobs`)
    ...
    function searchCompanyJobs(value: dashboardSearchJobs) {
        axios.get(`${urlJobs}/searchCompanyJobs`, { params: value })
            .then((response: AxiosResponse<jobDTO[]>) => {
                setJobs(response.data);
            });
    }
        ...
        <SelectedJobContext.Provider value={{ setSelectedJob: setSelectedJob }}>
            <div className="dashboard-box">
                <Grid container spacing={2} justifyContent="center" alignItems="center">
                    ...
                    <Grid item >
                        <div style={{ height: '390px', backgroundColor: 'white', borderRadius: '10px', marginBottom: '8px' }}>
                            {selectedJob ? <JobApplicantsTable job={selectedJob} style={{ maxHeight: '330px' }} /> : null}
                        </div>
                        <div style={{ height: '224px', backgroundColor: 'white', borderRadius: '10px', marginTop: '16px' }}>
                            <ApplicantsByJobTitle />
                        </div>
                    </Grid>
